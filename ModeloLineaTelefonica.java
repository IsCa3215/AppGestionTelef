...
public class ModeloLineaTelefonica extends AbstractListModel {
    ...
    private ArrayList<Llamada> listaLlamadas = new ArrayList<>(50);
    private ArrayList<LineaTelefono> ListaLineaTelefono = new ArrayList<>(50);
     ...
     */
    public ModeloLineaTelefonica( ModeloLineaTelefonica lt) {
 ...
 * @param nif
 */
    public static void eliminarLineaTelefono( ModeloLineaTelefonica[] lineas, String nif) {
    ...
    public Object getElementAt(int index) {
       return this.listaLlamadas.get(index);
    }
        public void addElement(Llamada user){
        listaLlamadas.add(user);
         }
        public Llamada removeElementAt(int index){
        return listaLlamadas.remove(index);
    }
            public int getSize() {
             return this.listaLlamadas.size();
